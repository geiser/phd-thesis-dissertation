...
which game elements should be introduced in the learning environment to deal with the motivational problems;
...
%theory aware systems for dealing with motivational problems in scripted collaborative learning
