...
The term game player (or player, for simplicity) is frequently used to describe individuals who play games, and there are different types of game players. There are people who take gaming seriously, playing full-fledged games a significant part of their daily lives. These players refer themselves as serious or hardcore gamers \citep{bosser2006hardcore}. On the other hand, casual gamers are people ranging from occasional game players \citep{kuittinen2007casual}. Based on characteristic that players exhibit within games such as competitiveness, sociability, exploratory behaviors, and individual personality traits, \citet{laws2002robin, nacke2011brainhex, bartle2004designing, marczewski2013gamification} identify different player typologies. 

Below, three main typologies of player types applied deeply explored in this dissertation are summarized.

%\begin{description}
%\item[Bartle's player types] \citep{bartle2004designing, bartle1996hearts} is the most popular classification of four-player types based on preferences of persons when they are playing a game. By studying players of the Multi-User Dungeon (MUD) game, \citet{bartle2004designing} identifies four players types (achievers, socializer, explorer, and killers) as shown in Figure \ref{fig:bartle-player-types}, in which there are two dimension of preferences: (1) the preference of interacting with other players (user-orientation) vs. exploring the game (system-orientation); and (2) the preference of unilateral action (action-orientation) vs. interaction in the game (interaction-orientation). Employing these preferences, the four player types are defined as follows:
...
%\begin{figure}[thbp]
%\begin{center}
%\includegraphics[width=0.55\textwidth]{bartle-player-types.png}
%\caption[Bartle's four-player types]{Bartle's four-player types (Adapted from \citep{bartle2004designing}).}
%\label{fig:bartle-player-types}
%\end{center}
%\end{figure}

%\item[Yee's Motivational Components] \citep{yee2006motivations, yee2006demographics} is a study done by Nick Yee who devised an experiment based on Bartle's four player types in which he conducted an extensive survey of Massive Multiplayer Online Role-Playing Games (MMORPGs) players for 3200 players answered 39 multiple-choice questions. Based on the results of this experiments, he derived ten motivational components grouped in three main components as shown in Table \ref{tab:yee-motivation-components}, where the main components are independent of each other. 

%\begin{table}[thbp] \scriptsize
%\begin{center}
%\begin{tabular}{|c|c|c|} \hline
...
\begin{figure}[htb]
 ...
 \centering
 \includegraphics[width=1\textwidth]{images/chap-general-background/spectrum-ontologies.png}
...
\begin{figure}[htb]
 ...
 \centering
 \includegraphics[width=0.85\textwidth]{images/chap-general-background/owl-example.png}
 \fdireta{Isotani2009}
\end{figure}
...
\begin{figure}[htb]
 ...
 \centering
 \includegraphics[width=1\textwidth]{images/chap-general-background/graph-bicycle-ontology.png}
 \fdireta{Isotani2009}
\end{figure}
...
\begin{figure}[htb]
 ...
 \centering
 \includegraphics[width=0.85\textwidth]{images/chap-general-background/learner-role-hozo.png}
 \fautor
\end{figure}
...
\begin{figure}[htb]
 ...
 \centering
 \includegraphics[width=0.75\textwidth]{images/chap-general-background/three-layer-model.png}
